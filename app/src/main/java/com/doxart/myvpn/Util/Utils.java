...
import com.doxart.myvpn.databinding.LoginSheetBinding;
...
public class Utils {
    ...
    public static BottomSheetDialog getLoginSheet(Context context) {
        LoginSheetBinding b = LoginSheetBinding.bind(LayoutInflater.from(context).inflate(R.layout.login_sheet, null));
    ...
    public static void openDoxart(Context context) {
        try {
            context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.doxart.net.tr")));
        } catch (Exception e) {
            Toast.makeText(context, "No app found.", Toast.LENGTH_SHORT).show();
        }
    }

    public static void openDoxartOnX(Context context) {
        context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/doxartsoftware")));
    }

    public static void openDoxartForReport(Context context) {
        context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.doxart.net.tr/report.html")));
    }
}
